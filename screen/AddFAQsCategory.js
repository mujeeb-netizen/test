...
export default function AddFAQsCategory({ navigation }) {
    function ViewList() {
    ...
    function getLinks_() {
        debugger
        setLoading(true);
        firebase.db.collection("FAQsCategory").onSnapshot(handleSnapshot_);
    }
    ...
    function confrmdelete(id) {
        const linkRef = firebase.db.collection("FAQsCategory").doc(id);
        linkRef
            .delete()
            .then(() => {
    ...
    function UpdateFAQsCategory() {
        if (type == null || type === "") {
            Alert.alert("Please Enter Type.")
        }
        else {
            const voteRef = firebase.db.collection("FAQsCategory").doc(editid);
    ...
    function AddFAQsCategory() {
        if (type == null || type == "") {
            ...
            firebase.db.collection("FAQsCategory").add(newLink);
                    ...
                    {!viewlist ?
                        <View>
                            ...
                            <View>
                                ...
                                <Button onPress={AddFAQsCategory} style={{}} title="Add" />
                            </View></View>
                                ...
                                <View>
                                    {isEdit ?
                                        <View>
                                            ...
                                            <Button onPress={() => UpdateFAQsCategory()} style={{}} title="Update" />
                                        </View> :
                                        <View style={{
                                            position: "absolute",
                                            top: 0,
